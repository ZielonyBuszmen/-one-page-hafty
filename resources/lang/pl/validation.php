...
return [
    ...
    */
    ...
    'after_or_equal'       => ':attribute musi być datą późniejszą bądź datą równą :date.',
    ...
    'before_or_equal'      => ':attribute musi być datą wcześniejszą lub datą równą :date.',
    'between'              => [
    ...
    */
    ...
    /*
     * Mówiąc pokrótce - tutaj chodzi o to, że wpisujemy nazwę atrybutu (pola z formularza),
     * oraz regułę walidacji (rule-name). W custom-message wpisujemy naszą wiadomość.
     * Tzn - zamiast wyświetlać "Pole login jest wymagane",
     * można dać np. "Drogi użytkowniku, proszę uprzejmie, wpisz swój login".
     *
     */
    ...
    */
    ...
    /*
     * Czyli - to taki mini słownik, który zamienia nazwy pól z bazy / formularza
     */
